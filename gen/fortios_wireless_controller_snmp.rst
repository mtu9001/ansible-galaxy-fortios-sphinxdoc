...
.. raw:: html
 ...
 <tr>
 <td>fortios_wireless_controller_snmp</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">wireless_controller_snmp</span> - Configure SNMP. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>wireless_controller_snmp</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">community</span> - SNMP Community Configuration. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">engine_id</span> - AC SNMP engineId string (maximum 24 characters). <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">trap_high_mem_threshold</span> - Memory usage when trap is sent. <span class="li-normal">type: int</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">user</span> - SNMP User Configuration. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">notify_hosts</span> - Configure SNMP User Notify Hosts. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
            ...
            <li> <span class="li-head">status</span> - SNMP User Enable <span class="li-normal">type: str</span> <span class="li-normal">choices: enable, disable</span>
