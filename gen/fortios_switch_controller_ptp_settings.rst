:source: fortios_switch_controller_ptp_settings.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_switch_controller_ptp_settings</td>
 <td>yes</td>
 <td>yes</td>
 </tr>
 </table>
...
.. raw:: html
    ...
    <li> <span class="li-head">switch_controller_ptp_settings</span> - Global PTP settings. <span class="li-normal">type: dict</span>
 ...
 <tr>
 <td>switch_controller_ptp_settings</td>
 <td>yes</td>
 <td>yes</td>
 </tr>
 </table>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">mode</span> - Enable/disable PTP mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: disable, transparent-e2e, transparent-p2p</span>
