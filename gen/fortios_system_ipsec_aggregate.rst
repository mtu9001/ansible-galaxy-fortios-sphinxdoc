:source: fortios_system_ipsec_aggregate.py
...
.. raw:: html
 ...
 <tr>
 <td>fortios_system_ipsec_aggregate</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
 <td>yes</td>
...
.. raw:: html
    ...
    <li> <span class="li-head">system_ipsec_aggregate</span> - Configure an aggregate of IPsec tunnels. <span class="li-normal">type: dict</span>
 ...
 <td>yes</td>
        ...
        <ul class="ul-self">
        <li> <span class="li-head">algorithm</span> - Frame distribution algorithm. <span class="li-normal">type: str</span> <span class="li-normal">choices: L3, L4, round-robin, redundant, weighted-round-robin</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">member</span> - Member tunnels of the aggregate. <span class="li-normal">type: list</span>
 ...
 <td>yes</td>
            ...
            <ul class="ul-self">
            <li> <span class="li-head">tunnel_name</span> - Tunnel name. Source vpn.ipsec.phase1-interface.name. <span class="li-normal">type: str</span>
 ...
 <td>yes</td>
        ...
        <li> <span class="li-head">name</span> - IPsec aggregate name. <span class="li-normal">type: str</span> <span class="li-required">required: True</span>
